...
public class RegisterTest {
    ...
    public void registerTest(){
        ...
        WebElement countryElement=Driver.findElement(By.xpath("//spam[@role='combobox']"));
        countryElement.click();
        WebElement selectCountryelement=Driver.findElement(By.id("select2-country-container"));
        ...
        WebElement mounthElement=Driver.findElement(By.xpath("//input[@ng-model='mountbox']"));
        Select mounthDropDown=new Select(mounthElement);
        mounthDropDown.selectByValue("February");
        ...
        uploadElement.sendKeys("C:\\poze\\Gura Portitei.jpg");
